package edu.orangecoastcollege.cs273.bAlbert;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(LoginActivity.this, "Account created successfully.  Please verify account by email.", Toast.LENGTH_LONG).show();
                            mUser = mAuth.getCurrentUser();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (mUser.isEmailVerified())
                                ...
                                Toast.makeText(LoginActivity.this, "Please verify your account at email: " + mUser.getEmail(), Toast.LENGTH_LONG).show();
                        }
                        else
